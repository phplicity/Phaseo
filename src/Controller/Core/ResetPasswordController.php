...
class ResetPasswordController extends AbstractController
{
     ...
     */
    #[Route('', name: 'core_public_forgot_password_request')]
    public function request(Request $request, MailerInterface $mailer, TranslatorInterface $translator): Response
    {
        ...
        return $this->render('core/reset_password/request.html.twig', [
            'requestForm' => $form,
        ]);
    }
     ...
     */
    #[Route('/check-email', name: 'core_public_check_email')]
     ...
     */
    #[Route('/reset/{token}', name: 'core_public_reset_password')]
    public function reset(Request $request, UserPasswordHasherInterface $passwordHasher, TranslatorInterface $translator, ?string $token = null): Response
    {
        if ($token) {
            ...
            return $this->redirectToRoute('core_public_reset_password');
        }
        ...
        try {
            ...
            return $this->redirectToRoute('core_public_forgot_password_request');
        }

        // The token is valid; allow the user to change their password.
        $form = $this->createForm(ChangePasswordFormType::class, null, ['label' => 0]);
        $form->handleRequest($request);
    ...
    private function processSendingPasswordResetEmail(string $emailFormData, MailerInterface $mailer, TranslatorInterface $tr): RedirectResponse
    {
        ...
        if (!$user) {
            return $this->redirectToRoute('core_public_check_email');
        }
        ...
        try {
            ...
            // the lines below and change the redirect to 'core_public_forgot_password_request'.
